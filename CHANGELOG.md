...
- Updated the dependency lockfile to remove all known high- and moderate-severity npm advisories
  without forced or breaking downgrades. CI now rejects new advisories at moderate severity or
  above; remaining low-severity upstream constraints are documented and reviewed separately.
