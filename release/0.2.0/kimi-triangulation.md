...
| **B3** nur 12 Fixtures, keine Voll-Eval | Branch-Manifest = **14**. Voll-Eval (3 Modelle) durch Afschin gelaufen: **93 % / 0.929 / FP 0 / FN 0**. | **kein Blocker** — Zahl belegt, bereits in Kaskade gesetzt |
...
| **W-F2 (multi-agent)** Merge-Trennung Kategorie/Lead nicht nachvollziehbar | Deckt sich mit offener Split-Frage aus dem Handoff. | **an G2-Checkpoint** (Merge-Strategie mit Afschin) |
...
- `mixed-intent.md` Golden-Label-Prüffall (aus Eval-Randbefund, Afschin).
