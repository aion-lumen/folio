...
1. **Reviewer-Rotation anwenden** (Direktive Z.159). Weicht von v2-Skill ab (dort ChatGPT fest). Absicht mit Afschin klären, wenn Lauf #3 startet — vermutlich: Reviewer bewusst wechseln, um Reviewer-spezifische blinde Flecken aufzudecken (Kimi-Lehre), nicht auf einen verlassen.
...
- **Zahlen-/Site-Änderungen = Coworks Kaskade + Afschins Freigabe**, nicht CCs Hand (gilt weiter).
- **Keine Credentials:** GitHub-PAT legt Afschin selbst an, CC referenziert nur den Secret-Namen. Cowork fasst Tokens ebenfalls nie an.
...
- **Re-Leak-Check:** Author == Committer, keine persönliche Mail. (E-Mail-Privacy ist bei Afschin aktiv — nicht reflexhaft als Befund melden, s. 0.3.0-Fieldnote.)
