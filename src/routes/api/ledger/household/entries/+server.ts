...
import {householdEntries} from '$lib/server/modules/ledger-books/household.js';
...
export const GET:RequestHandler=({locals,url})=>{
 ...
 try{return json(householdEntries(url.searchParams),{headers:{'cache-control':'private, no-store'}});}
